...
<div class="leftnav">
  ...
  <li><h2><a href="dep_list.action" target="right"><span class="icon-user"></span>二级学院管理</a></h2></li>
  <li><h2><a href="classes_list.action" target="right"><span class="icon-user"></span>班级管理</a></h2></li>
